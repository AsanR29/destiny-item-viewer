...
class DestinyRequest {
    ...
    async loginUser(form) {
        ...
        DD.player_directory[this.session_id] = {
    ...
    async getCharacters(data) {
        ...
        let r_url = "https://www.bungie.net/platform/Destiny2/" + data.Response[0]["membershipType"] + "/Profile/" + data.Response[0]["membershipId"];
