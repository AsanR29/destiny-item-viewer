...
class text_command {
    ...
    static save = new text_command("save", ["weapon","character","lore","socket","all"]);
...
const word_lookup = ["show", "weapon", "character", "lore", "socket", "manifest", "save", "read","plugset","sockettype","all"];
